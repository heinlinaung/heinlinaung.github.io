...
The site is now built with [Astro](https://astro.build), which means posts are plain markdown files in a folder. No CMS, no database, no admin UI — just files. That's the whole point.
